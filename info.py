...
BOT_TOKEN = environ.get('BOT_TOKEN',"")# "5965090572:")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-100938333392').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL','-1001863340529')
auth_grp = environ.get('AUTH_GROUP','-1001914868571')
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001863340529'))
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", " <b>{title}</b>   {languages} #HD \n \n 144P  -300 MB \n👉https://link.tnshort.net/536z \n \n 360P  -550MB \n👉https://link.tnshort.net/McJ1G7wV \n \n 720P  -900MB \n👉https://link.tnshort.net/Ph71 \n \n 1080P  -1.7GB  \n👉https://link.tnshort.net/Nc6Tut \n \n new movies :<b> [click here ⎚](https://link.tnshort.net/UbeiSp1)</b> ")
...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '634637418').split()]
...
CAPTION_BUTTON_URL = "https://t.me/filmztube"
